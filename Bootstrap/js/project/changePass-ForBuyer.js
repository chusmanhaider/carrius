...
var currentPassword = $("#yourPassword").val();
var newPassword = $("#rePassword").val();
var confirmPassword = $("#reNewPassword").val();

if(currentPassword == "" || newPassword == "" || confirmPassword == "") {
if(currentPassword == "") {
    $("#yourPassword").after('<p class="text-danger">Current Password field is required</p>');
    $("#yourPassword").closest('.form-group').addClass('has-error');
} else {
    $("#yourPassword").closest('.form-group').removeClass('has-error');
    $(".text-danger").remove();
}
