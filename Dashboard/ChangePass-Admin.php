...
<html lang="en">
    ...
    <body>
					...
					<div class="col-md-9" style="margin-left:9%">
						<div class="panel panel-default" id="passChangePanel">
							...
							<div class="panel-body">
								<form action="changeAdminPass-action.php" id="changePassword" method="post" class="form-horizontal">
									<fieldset>
										...
										<div class="form-group">
											<div class="col-sm-offset-5 col-sm-10">
												<input type="hidden" name="user_id" id="user_id" value="<?php echo $result['admin_ID']; ?>" /> 
		...
		<script src="Bootstrap/js/project/changePass-Admin.js"></script>
    </body>
</html>
