...
<html lang="en">
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <div class="page-heading"> <i class="fa fa-car fa-fw"></i> All Cars
                                <?php
                                    $count=0;
                            ...
                            <div class="panel-body">
                                <div class="row">
                                    <div class="col-sm-3 pull pull-left" style="float:left;">
                                        <label for=""><b>Brand Search</b></label>
                                    </div>
                                    
                                    <div class="col-sm-3 pull pull-right" style="margin-right:-1px;">
                                        <label for=""><b>Car Condition</b></label>
                                    </div>
                                    <div class="col-sm-3 pull pull-right" style="margin-right:-1px;">
                                        <label for=""><b>Car Electric</b></label>
                                    </div>
                                    <div class="col-sm-3 pull pull-left" style="float:left;">
                                ...
                                <div class="container-fluid">
                                    ...
                                    <div class="col-sm-3 pull pull-left" style="float:left;">
                                        <select name="prodc" class="form-control text-capitalize" id="carNameSearch">  
                                    ...
                                    <div class="col-sm-3 pull pull-right" style="float:right;">
                                        <select name="brand" class="form-control text-capitalize" id="carConditionSearch">  
                                    ...
                                    <div class="col-sm-3 pull pull-right" style="float:right;">
                                        <select name="brand" class="form-control text-capitalize" id="electricSearch">  
                                            <option value="">Select Car Electric</option>  
    ...
    <div class="modal fade" id="contactDealerModal" tabindex="-1" role="dialog">
        ...
        $('#prodc').change(function(){ 
			...
			if(brand_id!='')
			{
                //$('#carNameSearch').attr("disabled",true);
				$('.news_table').hide();
				$('#show_product').show();
				$.ajax({  
			...
			{
                //$('#carNameSearch').attr("disabled",false);
				$('.news_table').show();
				$('#show_product').hide();
			}
		});      
