                ...
                <ul class="nav navbar-right navbar-top-links">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            <li>
								<img src="<?php echo "../".$myImage;?>" alt="Profile Picture" class="avatar">
							</li>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            <li>
                                <a href="Buyer.php" class="active"><i class="fa fa-home fa-fw"></i> Home</a>
                            </li>
							<li>
                ...
                <div class="row">
                            ...
                            <div class="panel-heading">
                                <div class="row">
                                    ...
                                    <div class="col-xs-9 text-right">
                                        ...
                                        WHERE (cars.car_Status='Available' AND cars_brand.carBrand_Status='Available')
                                        ...
                                        <div>Favourite Cars</div>
                                    </div>
                                </div>
                            </div>
                            <a href="#">
                                <div class="panel-footer">
                                    <span class="pull-left"><a href="My Fav Car.php">View Details</a></span>
					...
					<div class="col-lg-3 col-md-6">
                        <div class="panel panel-info">
                            ...
                            <a href="#">
                                <div class="panel-footer">
                                    <span class="pull-left"><a href="Contact-Dealer.php">View Details</a></span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                                </div>
                            </a>
