...
$d_id=$_GET['id'];
$query="Select * from dealer where dealer_ID='$d_id' AND dealer_Status!='Terminated'";
$re=mysqli_query($connect, $query);
$row=mysqli_fetch_assoc($re);
$fname=$row['dealer_FName'];
$lname=$row['dealer_LName'];
$fname=$row['dealer_FName'];
?>
...
<html lang="en">
    <head>
        <meta charset="utf-8">
		<title>Admin Panel-Reset Dealer Password</title>
    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
				<div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Reset Dealer Password</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
				<div class="row">
					<div class="col-md-9" style="margin-left:9%">
						<div class="panel panel-default" id="passChangePanel">
							<div class="panel-heading">
								<div class="page-heading"> <i class="fa fa-lock fa-fw"></i> Reset Dealer Password</div>
							</div> <!-- /panel-heading -->

							<div class="panel-body">
								<form action="resetdealerpassword-action.php" id="changePassword" method="post" class="form-horizontal">
									<fieldset>
										...
										<div class="form-group">
											...
											<div class="col-sm-3">
											  <input type="text" readonly="" value="<?php echo $row['dealer_FName'];?>" class="form-control" id="firstName" name="firstName"/>
											</div>
											<label for="password" class="col-sm-2 control-label">Last Name</label>
											<div class="col-sm-4">
											  <input type="text" readonly="" value="<?php echo $row['dealer_LName'];?>" class="form-control" id="lastName" name="lastName"/>
											</div>
										</div>
										<div class="form-group">
											<label for="password" class="col-sm-3 control-label">Dealership Name</label>
											<div class="col-sm-9">
											  <input type="text" readonly="" value="<?php echo $row['dealer_Dealership'];?>" class="form-control" id="rePassword" name="rePassword"/>
											</div>
										</div>
										<div class="form-group">
											<label for="password" class="col-sm-3 control-label">Location</label>
											<div class="col-sm-9">
											  <input type="text" readonly="" value="<?php echo $row['dealer_Location'];?>" class="form-control" id="rePassword" name="rePassword"/>
											</div>
										</div>
										...
										<div class="form-group">
											<div class="col-sm-offset-5 col-sm-10">
												...
												<input type="hidden" name="dealer_id" id="dealer_id" value="<?php echo $_GET['id']; ?>" /> 
		...
		<script src="Bootstrap/js/project/changePass-ForDealer.js"></script>
    </body>
</html>
