...
<?php  
    ...
    car_gallery.CarId = cars.car_ID WHERE cars.car_Status!='Terminated' AND cars.car_ID='$curr_Id' AND 
    (car_gallery.carGallery_Status != 'Terminated' AND car_gallery.carGallery_Status != 'Archived' AND car_gallery.carGallery_Status != 'Not Available')";
