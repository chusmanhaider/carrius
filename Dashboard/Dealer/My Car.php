...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Dealer Panel - My Cars</title>
    ...
    <body>
        <div id="wrapper">
			...
			<div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">My Cars</h1>
                    </div>
                    <!-- /.col-lg-12 -->
                </div>
                <!-- /.row -->
        ...
        <!-- /#wrapper -->
	<!-- add car -->
	<div class="modal fade" id="addMyCarModal" tabindex="-1" role="dialog">
		<div class="modal-dialog" style="width:45%;margin-top:1%">
			<div class="modal-content">
				<form class="form-horizontal" id="submitCategoryForm" action="createMyCar.php" method="POST" enctype="multipart/form-data">
						...
						<div class="tab-content">
							...
							<div id="vehicleOverview" class="tab-pane fade">
								...
								<div class="form-group">
									...
									<label for="categoryName" class="col-sm-2 control-label">Colour</label>
									<div class="col-sm-3">
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
										<input type="text" class="form-control text-capitalize" maxlength="40" required id="carDrivetrain" placeholder="Drivetrain" name="carDrivetrain" autocomplete="off">
									</div>
								</div>
								<div class="form-group">
							...
							<div id="image" class="tab-pane fade">
								<h3>Image Gallery</h3>
								<div class="form-group">
									<label for="categoryName" class="col-sm-4 control-label">Image :1*</label>
									<div class="col-sm-7">
										<input type="file" name="fileOne" id="fileOne" required accept="image/x-png,image/gif,image/jpeg"  class="form-control text-capitalize" required autocomplete="off">
									</div>
								</div>
								<div class="form-group">
									<label for="categoryName" class="col-sm-4 control-label">Caption (1st Image)</label>
									<div class="col-sm-7">
								...
								<hr>
								<div class="form-group">
									<label for="categoryName" class="col-sm-4 control-label">Image :2*</label>
									<div class="col-sm-7">
										<input type="file" name="fileTwo" id="fileTwo" required accept="image/x-png,image/gif,image/jpeg"  class="form-control text-capitalize" required autocomplete="off">
									</div>
								</div>
									<div class="form-group">
										<label for="categoryName" class="col-sm-4 control-label">Caption (2nd Image)</label>
										<div class="col-sm-7">
								...
								<hr>
								<div class="form-group">
									<label for="categoryName" class="col-sm-4 control-label">Image :3*</label>
									<div class="col-sm-7">
										<input type="file" name="fileThree" id="fileThree" required accept="image/x-png,image/gif,image/jpeg"  class="form-control text-capitalize" required autocomplete="off">
									</div>
								</div>
								<div class="form-group">
									<label for="categoryName" class="col-sm-4 control-label">Caption (3rd Image)</label>
									<div class="col-sm-7">
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<form class="form-horizontal" id="update_form" method="POST">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						<h4 class="modal-title"><i class="fa fa-edit"></i> Update Car</h4>
					</div>
					<div class="modal-body">
						<div id="add-category-messages">
						</div>
						...
						<div class="tab-content">
							...
							<div id="updateVehicleOverview" class="tab-pane fade">
								...
								<div class="form-group">
									<label for="categoryName" class="col-sm-3 control-label">CO2 emissions</label>
									<div class="col-sm-5">
										<input type="text" class="form-control text-capitalize" maxlength="40" required id="upCarCOEmission" placeholder="CO2 Emissions" name="upCarCOEmission" autocomplete="off">
									</div>
									<div class="col-sm-3">
										<input type="text" class="form-control" value="grams/kg" readonly="" >
									</div>
							...
							<div id="updateKeyFeature" class="tab-pane fade">
								...
								<div class="form-group">
									<label for="categoryName" class="col-sm-3 control-label">Lane Departure Warning</label>
									<div class="col-sm-8">
										<select class="form-control text-capitalize" required id="uplaneDepartureWarning" name="uplaneDepartureWarning">
											<option value="">Select Lane Departure Warning</option>
											<option value="Yes">Yes</option>
											<option value="No">No</option>
										</select>
	...
	<div class="modal fade" id="viewremoveCarModal" tabindex="-1" role="dialog">
