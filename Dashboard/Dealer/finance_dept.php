...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Dealer Panel - Finance Department</title>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-info">
                            <div class="panel-heading">
                                <i class="fa fa-users"></i> Manage Finance Department
                            ...
                            <div class="dataTable_wrapper" style="margin-top: 2%;">
								<div class="category_table">
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                            <?php
                                                $sql_admin="Select * from finance_dept where DealerId='$dealer_id'";
                                            ...
                                            <tr id="<?php echo $line['finDept_ID']; ?>">
                                                ...
                                                <?php 
                                                    ...
                                                    else if($line['finDept_Status']=="Suspended")
	...
	<div class="modal fade" id="addMemberModal" tabindex="-1" role="dialog">
		<div class="modal-dialog" style="width:40%;margin-top:4%">
			<div class="modal-content">
				<form class="form-horizontal" id="submitCategoryForm" action="createFinanceDeptMember.php" method="POST" enctype="multipart/form-data">
					<div class="modal-header">
						<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
						<h4 class="modal-title"><i class="fa fa-plus"></i> Add Finance Department Member</h4>
					</div>
