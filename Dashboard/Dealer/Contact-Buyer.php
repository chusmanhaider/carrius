    ...
    <body>
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Contact Buyers</h1>
                    </div>
                </div>
                <div class="row">
					<div class="col-lg-12">
                        <div class="panel panel-info">
							<div class="panel-heading">
							 <div class="row">
							  <div class="col-md-6"><i class="fa fa-envelope-square fa-fw"></i> Contact Buyers</div>
							 </div>
							</div>
							...
							<div class="remove-messages">
								...
								<div class="row">
									<div class="pull pull-right" style="padding-bottom:20px;margin-right:20px">
										<button class="btn btn-primary button1" data-toggle="modal" id="addRequesModalBtn" data-target="#addRequestModal"> <i class="fa fa-envelope-square fa-faw"></i> Contact Buyer</button>
									</div>
									<div class="pull pull-left" style="margin-left:20px;">
										<a href="Contact-Buyer.php" class="btn btn-info">
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-capitalize text-center">City</th>
                                        ...
                                        <tbody>
											<?php
                                                ...
                                                INNER JOIN contact_dealer ON buyer.buyer_ID=contact_dealer.buyerId
                                                INNER JOIN contact_dealer_reply ON contact_dealer_reply.conDealerId=contact_dealer.conDealer_ID
                                                WHERE buyer.buyer_Status='Active' GROUP BY buyer.buyer_ID"; 
											...
											<tr id="<?php echo $row['dealer_ID'];?>">
												...
												<td class="text-center">
                                                    <button class="btn btn-sm btn-circle btn-primary contactDealer" id="<?php echo $row["buyer_ID"]; ?>">
														<span data-toggle='tooltip' title="Contact Dealer"><i class='fa fa-envelope-square fa-lg'></i></span>
													</button>
													
													<button style="margin-left:10px;" class="btn btn-sm btn-circle btn-info view_detail" id="<?php echo $row["buyer_ID"]; ?>">
			...
			<div class="modal fade" id="addRequestModal" tabindex="-1" role="dialog">
				<div class="modal-dialog" style="width:65%;margin-top:1%">
					<div class="modal-content">
						<form class="form-horizontal" id="submitCategoryForm" action="createContactBuyer.php" method="POST" enctype="multipart/form-data">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
								<h4 class="modal-title"><i class="fa fa-envelope-square"></i> Contact Buyer</h4>
							</div>
							<div class="modal-body" id="" style="max-height:450px; overflow:auto;">
								<div class="form-group">
									<label for="categoryName" class="col-sm-2 control-label">Buyer Name </label>
									<div class="col-sm-4">
                                        <select class="form-control text-capitalize" required id="carDealerContact" name="carDealerContact">
                                            <option value="" id="">Select Buyer Name</option>
                                            <?php
                                                $sql_d="SELECT * from buyer Where buyer_Status!='Terminated'";
                                                ...
                                                if($numROW_Dealer>0)
                                                {
                                                    ...
                                                    {
                                            ?>
                                            <option class='text-capitalize' name="<?php echo $var['buyer_ID'];?>" id="<?php echo $var['buyer_ID'];?>" value="<?php echo $var['buyer_FName']. " ".$var['buyer_LName'];?>"><?php echo $var['buyer_FName']. " ".$var['buyer_LName'];?></option>
							...
							<div class="modal-footer">
								<input type="hidden" id="dealer_id" value="<?php echo $Id;?>" name="dealer_id">
				...
				<div class="modal-dialog">
					<div class="modal-content">
						<form class="form-horizontal" id="replyTo" method="POST">
							...
							<div class="modal-footer">
								<input type="hidden" id="dealerId" name="dealerId" value="<?php echo $Id;?>">
								<input type="hidden" id="buyer_id" name="buyer_id">
		...
		$('#carDealerContact').on('change',function () {
			var buyer_id = $(this).children("option:selected").attr("id");
			//alert(dealer_id);
			if(buyer_id!='')
			{
				$.ajax({
				url:"fetchContactDetail-Buyer.php",  
				method:"POST",  
				...
				success:function(data)
				{
					//$('#updateCarName').val(data.car_Name);
						//alert(data.contact_topic);
					$('#location').val(data.buyer_Address+", "+data.buyer_City);
					$('#email').val(data.buyer_Email);
					$('#cellNum').val(data.buyer_CellNumber);
