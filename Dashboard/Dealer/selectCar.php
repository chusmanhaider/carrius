<?php  
	if(isset($_POST["car_id"]))  
	{
		...
		WHERE cars.car_Status!='Terminated' AND cars.car_ID='$curr_Id'";
...
<div class="table-responsive">
		<table class="table table-bordered table-striped table-hover">
			...
			<tr>
				...
				<td class="text-capitalize text-center">
					<?php 
						...
						else if($row["car_AutoStatus"]=="Pending")
						{
							if($row["car_Status"]=="Available")
							{
								...
								echo"<br><i style='color:red;font-size:12px'>Kindly approve</i>";
							}
							else if($row["car_Status"]=="Pending")
							{
								echo "<label class='label label-info'>Pending</label><span data-toggle='tooltip' title='Admin approval required'><i style='margin-left:2px;' class='fa fa-question-circle'></i></span>";
								echo"<br><i style='color:red;font-size:12px'>Kindly approve</i>";
							}
							else if($row["car_Status"]=="Rejected")
							{
								echo "<label class='label label-danger'>Rejected</label><span data-toggle='tooltip' title='Admin approval required'><i style='margin-left:2px;' class='fa fa-question-circle'></i></span>";
								echo"<br><i style='color:red;font-size:12px'>Kindly approve</i>";
							}
							else if($row["car_Status"]=="Not Available")
							{
								echo "<label class='label label-warning'>Not Available</label><span data-toggle='tooltip' title='Admin approval required'><i style='margin-left:2px;' class='fa fa-question-circle'></i></span>";
								echo"<br><i style='color:red;font-size:12px'>Kindly approve</i>";
							}
						}	
						else
			...
			<tr> 
                ...
                <td colspan="3"><?php 
						$time=$row['car_tStamp'];
						echo $date = date("d-M-Y g:i A", strtotime($time));?></td>  
            </tr>
			<?php
				}
			?>
