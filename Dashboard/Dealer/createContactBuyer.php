...
{	
	...
	$notifyDesc=$car_Dealer." has contacted you. Go into Contact Dealer section and reply him";
    ...
    VALUES ('$requestMsg','$status','$buyer_id','-1','$dealer_id')";
		...
		if($last_id!="")
		{
			...
			if(mysqli_query($connect, $sqli_conReply))
			{
				...
				if(mysqli_query($connect, $sql_notify))
				{
					...
					{
						header('location: Contact-Buyer.php?msg=Success');
					}
					else
						header('location: Contact-Buyer.php?msgErr1=ErrorWhileAddingNotificationBy');
				}
				else
					header('location: Contact-Buyer.php?msgErr2=ErrorWhileAddingNotification');
			}
			else
				header('location: Contact-Buyer.php?msgErr3=ErrorWhileAdding');
		}
        else
			header('location: Contact-Buyer.php?msgErr4=ErrorWhileAddingX');
	} 
	else 
	{
		header('location: Contact-Buyer.php?msgErr5=Error');			
	}
}
?>
