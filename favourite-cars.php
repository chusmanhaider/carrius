<html>
<head>
    <title>Carrius - Favourite Cars</title>
    ...
    <div class="wrapper" style="background-color: white;">
        <div class="container">
            <div class="innerBlock">
                <h2 class="text-center alignHeading"><b>Your Favourite List</b></h2>
                <span class="alignAddMoreCarBtn">
                    <button class="addBtnCar">Add More cars to List</button>
                </span>
                ...
                <p class="text-center alignCenter" style="color:#999999;max-width:345px;">
                    Here, you can easily select your car and contact each
                    dealership until you find the right ONE!
                </p>
                <span class="alignAddMoreCarBtnTwo">
                    <button class="addBtnCar">Add More cars to List</button>
                </span>
                <span class="usedCarDetail">
                    <span class="row">
                        ...
                        <?php
                            ...
                            {
                                echo "<h3 style='text-align:center;color:red;margin-top:40px; margin-bottom:163px;margin-right:8%;'> No favourite car found..</h3>";
                            }
                        ?>
                    </span>
                </span>         
