        ...
        <div class="wrapper" style="background-color: white;">
            <div class="container">
                <div class="iContainer">
                    <h4>Your Marked <b>Favourite Car List</b></h4>
                    <span class="alignAddMoreCarBtn">
                        <a href="all-cars-model.php"><button class="addBtnCar">Add More cars to List</button></a>
                    </span>
                            ...
                            <div class="contentBlock">
                                <div class="row">
                                    ...
                                    <?php
                                        ...
                                        {
                                            echo "<span style='color:red;font-weight:bold;font-size:22px;' class='noCarFound'>No Car is marked Favourite</span>";
                                        }
                                    ?>
                                <!--
                                    <div class="col col-lg-4 col-xs-6 addBlockTop eachBlock">
