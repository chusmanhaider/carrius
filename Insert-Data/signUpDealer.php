...
{	
	...
	'$phoneNumber', '$dTotal', '$email', '$status', '$dType', '$cStock', '$sAgents', '$comment', '$added_by')";
	

	if(mysqli_query($connect, $sql_dealer))
	{
		
		header('location: ../join-us.php?msg=Success');
    }
	else 
	{
		header('location: ../join-us.php?msgError=Error');			
	}
}
?>
