<html>
<head>
    <title>Carrius - Our Services</title>
    ...
    <link href="css/our-services.css" rel="stylesheet">
</head>
<body>
    <?php
    ...
    <div class="wrapper" style="background-color: white;">
        <div class="container-fluid setHeight" style="background-color: #044cc4;">
            <div class="innerBlock">
                ...
                <p class="text-center alignCenter" style="color:white;max-width:550px">
                    We don't want to push our ideas on customers, we simply want to make what they want
                </p>
                <span class="btnAlign">
                    <a href="faq.php"><button class="faqBtn">See FAQ</button></a>
                    <a href="join-us.php"><button class="joinBtn">Join Us</button></a>
                </span>
            </div>
        </div>
        <div class="container">
                ...
                <div class="row">
                    <div class="col col-lg-3 col-xs-6 firstCol">
                        ...
                        <p  style="color:#999999;font-size:16px;text-align:center;">
                            ...
                            critical priority to digitization.
                        </p> 
                    </div>
            ...
            <div class="lastPart">
                <h3 style="color: black;"><b>Have any other question?</b></h3>
                <a href="contact-us.php"><button type="button" id="btnGetTouch">Get in Touch now</button></a>
            </div>
        </div>
    </div><!-- End of Wrapper-->
    <?php
