    ...
    <div class="wrapper" style="background-color: white;">
        <div class="container">
            <div class="innerBlock">
                <h2 class="text-center alignHeading"><b>New Cars</b></h2>
                ...
                <p class="text-center alignCenter" style="color:#999999;max-width:345px;">
                    Here, you can easily view all new cars and contact each
                ...
                <span class="usedCarDetail">
                    <span class="row">
                        ...
                        <?php
                            ...
                            {
                                echo "<h3 style='text-align:center;color:red;margin-top:40px; margin-bottom:163px;margin-right:8%;'> No new car found..</h3>";
                            }
                        ?>
                    </span>
                </span>         
